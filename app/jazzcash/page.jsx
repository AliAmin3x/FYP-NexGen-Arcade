...
const jazzcashPayment = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#181818] text-white">
            <h2 className="text-3xl font-bold mb-4">JazzCash Payment</h2>
            <div className="bg-[#303030] p-6 rounded-lg shadow-md w-full max-w-sm">
                <form onSubmit={handleConfirm}>
                    <p>Please make payment of your purchase to our EasyPaisa Account: 03010004273</p>
                    <div className="mt-5">
                        <label htmlFor="transaction-id" className="mb-4">Transaction ID:</label>
                        <input
                            type="text"
                            id="transaction-id"
                            name="transaction-id"
                    ...
                    <div className="mt-5">
                        <label htmlFor="transaction-reciept" className="mb-4">Please Upload your Transaction receipt:</label>
                        <input
                            type="file"
                            id="image"
