...
const FeaturedGames = () => {
    ...
    useEffect(() => {
        const fetchGames = async () => {
            try {
                const q = query(collection(db, 'games'), where('type', '==', 'featured'));
    ...
    return (
        <div className='bg-[#181818] flex flex-col min-h-screen'>
            ...
            <div className='container mx-auto text-white text-center py-8'>
                <motion.h2 className="text-4xl font-semibold mb-8" variants={headingAnimation}>
                    Featured Games
                </motion.h2>
                <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {paginatedGames.map((game, index) => (
                        ...
                        >
                            ...
                            <p className="text-gray-300">PKR {game.price}</p>                            <motion.button
