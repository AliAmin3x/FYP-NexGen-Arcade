  ...
  return (
    <div className="bg-[#181818] flex flex-col min-h-screen">
      ...
      <div className="container mx-auto text-white py-8">
        <motion.h2 className="italic text-2xl text-center font-semibold mb-8" variants={sectionAnimation} initial="initial" animate="animate">Dashboard</motion.h2>
          ...
          <motion.div className="ml-8 bg-[#303030] p-6 rounded-lg shadow-md w-full md:w-3/4" variants={sectionAnimation} initial="initial" animate="animate">
            ...
            {games.map(game => (
              <div key={game.id} className="flex gap-4 items-center mb-4 bg-[#4e4949] p-4 rounded-lg shadow-md hover:bg-[#606060] transition-colors duration-300 hover:scale-95 justify-around">
                ...
                <div className={`flex flex-col items-center px-4 py-1 rounded-lg text-white ${game.status === "Pending" ? "bg-yellow-500" : game.status === "Approved" ? "bg-green-500" : "bg-red-500"}`}>
