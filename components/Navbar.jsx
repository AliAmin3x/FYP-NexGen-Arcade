                ...
                {showPopup && (
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1 sm:gap-2">
                            ...
                            <Link href="/developer/signup" className="flex items-center gap-1 sm:gap-2 hover:text-purple-500 bg-[#505050] rounded-lg p-1 sm:p-2">
                                <FaUserPlus size={14} className="sm:text-lg" />
                                Sign Up as Developer
                            </Link>
                            <Link href="/" className="flex items-center gap-1 sm:gap-2 hover:text-purple-500 bg-[#505050] rounded-lg p-1 sm:p-2">
