...
const SearchBar = () => {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto" style={{fontFamily:'var(--font-ui)'}}>
            ...
            {games.map((game, i) => (
              <motion.button key={game.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.04 }}
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-white truncate" style={{fontFamily:'var(--font-body)'}}>{game.title}</p>
